...
>
  <Carousel
    withIndicators
    height="100%"
    loop={false} // O loop continua para mudar as imagens automaticamente
    controlSize={45} // Tamanho ajustado dos controles
    dragFree={false} // Desabilita a interação manual com os slides
    styles={{
  ...
  style={{
    ...
    left: "10%", // Ajuste para mover para o lado esquerdo
    ...
    borderRadius: "10px",
    zIndex: 10, // Garante que a caixa de texto fique sobre as imagens
    width: "750px", // Define uma largura fixa para a caixa de texto
  }}
>
  <h2 style={{ fontSize: "30px", fontWeight: "bold" }}>Partnership Club</h2>
  <p style={{ fontSize: "16px", fontWeight: "bold", marginTop: "10px", color: "white" }}>
...
>
  ...
  >
    ...
    >
      Nome do autor é um escritor, explorador e viajante apaixonado por criar experiências inesquecíveis. Com uma vasta
      experiência em viagens, ele tem o objetivo de compartilhar as histórias mais emocionantes e inspiradoras.
    </p>
    <p
      style={{
        fontSize: "22px",
    ...
    >
      Ao longo de sua carreira, o autor teve a oportunidade de explorar diversos destinos ao redor do mundo, vivendo
      aventuras que transformaram sua visão de vida e a maneira como ele compartilha suas experiências com o público.
    </p>
  </div>
